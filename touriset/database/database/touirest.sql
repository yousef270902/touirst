...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2024 at 03:04 PM
...
(6, 'ali@gmail.com', 'cairo Citadel '),
(7, 'ali@gmail.com', 'Cairo Tower');
...
CREATE TABLE `rate` (
  `id` int(11) NOT NULL,
  `rate_place` varchar(100) NOT NULL,
...
INSERT INTO `rate` (`id`, `rate_place`, `rate`, `user`) VALUES
(1, 'pyrmaids', 4, 'ali@gmail.com');
...
--
ALTER TABLE `rate`
  ADD CONSTRAINT `rate_place` FOREIGN KEY (`rate_place`) REFERENCES `places` (`place`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `user` FOREIGN KEY (`user`) REFERENCES `users` (`email`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
